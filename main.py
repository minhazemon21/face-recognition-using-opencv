...
#imgTest = face_recognition.load_image_file('image/messi.png')
imgTest = face_recognition.load_image_file('image/Elon-Test.jpg')
#imgTest = cv2.resize(imgT, (100,50))
...
cv2.putText(imgTest,f"{result}{round(faceDis[0],2)}",(20,40),cv2.FONT_ITALIC,1,(255,255.0))
